...
namespace NonFactors.Mvc.Grid.Tests.Unit
{
    ...
    public class GridColumnTests
    {
        ...
        [TestCase(null, "", null, "#")]
        [TestCase(false, "", null, "#")]
        [TestCase(true, "", null, "?Sort-Grid%20-Name=Asc")]
        [TestCase(true, "", GridSortOrder.Asc, "?Sort-Grid%20-Name=Desc")]
        [TestCase(true, "", GridSortOrder.Desc, "?Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&On=true", null, "?Id=4&On=true&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Grid -Name=Asc", null, "?Id=4&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Grid -Column=Asc", null, "?Id=4&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Name=Asc", null, "?Id=4&Sort-Name=Asc&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Column=Asc", null, "?Id=4&Sort-Column=Asc&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Grid -Name=Desc", null, "?Id=4&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Name=Desc", null, "?Id=4&Sort-Name=Desc&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Grid -Name=Asc", GridSortOrder.Asc, "?Id=4&Sort-Grid%20-Name=Desc")]
        [TestCase(true, "Id=4&Sort-Grid -Column=Asc", GridSortOrder.Asc, "?Id=4&Sort-Grid%20-Name=Desc")]
        [TestCase(true, "Id=4&Sort-Name=Asc", GridSortOrder.Asc, "?Id=4&Sort-Name=Asc&Sort-Grid%20-Name=Desc")]
        [TestCase(true, "Id=4&Sort-Grid -Name=Desc", GridSortOrder.Desc, "?Id=4&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Grid -Column=Desc", GridSortOrder.Desc, "?Id=4&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Name=Desc", GridSortOrder.Desc, "?Id=4&Sort-Name=Desc&Sort-Grid%20-Name=Asc")]
        [TestCase(true, "Id=4&Sort-Column=Desc", GridSortOrder.Desc, "?Id=4&Sort-Column=Desc&Sort-Grid%20-Name=Asc")]
